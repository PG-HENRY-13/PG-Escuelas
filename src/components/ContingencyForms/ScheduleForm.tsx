                        ...
                        <fieldset>
                          ...
                          <div className="form-check mb-3">
                            ...
                            <label className="form-check-label">
                              Hora/s extra/s (en caso de exceder la cantidad de
                              horas de su jornada habitual)
                            </label>
                          </div>
                          <div className="form-check mb-3">
                            <input
                            ...
                            ></input>
                            <label className="form-check-label">
                              Llegada tarde (en caso de modificar su horario de
                              inicio de jornada manteniendo el de finalización)
                            </label>
                          </div>
                          <div className="form-check mb-3">
                            <input
                            ...
                            ></input>
                            <label className="form-check-label">
                              Retiro Anticipado (en caso de modificar su horario
                              de finalización de jornada manteniendo el de
                              inicio)
                            </label>
                          </div>
                        </fieldset>
